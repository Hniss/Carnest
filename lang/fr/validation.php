...
/*
 * Lot 3 — messages de validation en français (produit monolingue).
 * Rédigés pour CareNest ; couvrent l'ensemble des règles standard de Laravel.
 */
return [
    ...
    'attributes' => [
        ...
        'newParentId'           => 'parent',
        'newNote'               => 'note',
        'actionTypes'           => 'actions réalisées',
        'actionNotes'           => 'notes',
        'followStatus'          => 'statut du suivi',
        'followDate'            => 'date du prochain point',
        'followObjective'       => 'objectif du suivi',
        'followResponsable'     => 'responsable du suivi',
        'synthesisIdentified'   => 'bloc « ce que CareNest a identifié »',
        'synthesisSchoolDid'    => 'bloc « ce que l\'école a fait »',
        'synthesisSchoolProposes' => 'bloc « ce que l\'école propose »',
        'synthesisParentCan'    => 'bloc « ce que vous pouvez faire »',
        'alertThreshold'        => 'seuil d\'alerte',
        'schoolHoursStart'      => 'heure d\'ouverture',
        'schoolHoursEnd'        => 'heure de fermeture',
        'dailyTokenCap'         => 'plafond journalier',
        'sessionMaxMinutes'     => 'durée maximale de séance',
        'referentPhone'         => 'téléphone du référent',
        'adminPhone'            => 'téléphone de l\'administration',
        'notificationChannels'  => 'canaux de notification',
        'delegateId'            => 'compte délégué',
        ...
        'form.gender'           => 'genre',
        'form.email'            => 'identifiant de connexion',
        'form.password'         => 'mot de passe',
        'form.parent_email'     => 'e-mail du parent',
        'form.parent_name'      => 'nom du parent',
